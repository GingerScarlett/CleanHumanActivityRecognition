...
For this dataset, the following modifications were done to the original set located at 
...
1. combinedhar.csv - this is file combines the test and training data sets, which were originally distributed in 
separate folders. Also, the data set contains te descriptive variable names in the same file, as headings

2. meanstdactivitynames.csv - this is a subset  of the combinedhar.csv file that contains only the measurements on 
the mean and standard deviation for each measurement

3. combinedactivitynames.csv - this is a further enhancement on the combinedhar.csv, with an additional column 
containing descriptive activity names

4. byactivitysummary.csv - this contains a summary (mean) of all fields, grouped by activity
